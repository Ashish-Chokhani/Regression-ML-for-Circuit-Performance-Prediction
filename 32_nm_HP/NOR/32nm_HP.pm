...
+tnom    = 27              toxe_n    = 1.15e-009       toxp    = 9e-010          toxm_n    = 1.15e-009     
+dtox    = 2.5e-010        epsrox  = 3.9             wint    = 5e-009          lint    = 2.7e-009      
+ll      = 0               wl      = 0               lln     = 1               wln     = 1             
+lw      = 0               ww      = 0               lwn     = 1               wwn     = 1             
+lwl     = 0               wwl     = 0               xpart   = 0               toxref_n  = 1.15e-009     
+xl	   = -14e-9
...
+dvtp1   = 0.1             lpe0    = 0               lpeb    = 0               xj_n      = 1e-008        
+ngate   = 1e+023          ndep_n    = 4.12e+018       nsd     = 2e+020          phin    = 0             
...
+tnom    = 27              toxe_n    = 1.2e-009        toxp    = 9e-010          toxm_n    = 1.2e-009      
+dtox    = 3e-010          epsrox  = 3.9             wint    = 5e-009          lint    = 2.7e-009      
+ll      = 0               wl      = 0               lln     = 1               wln     = 1             
+lw      = 0               ww      = 0               lwn     = 1               wwn     = 1             
+lwl     = 0               wwl     = 0               xpart   = 0               toxref_n  = 1.2e-009      
+xl	   = -14e-9
...
+dsub    = 0.1             minv    = 0.05            voffl   = 0               dvtp0   = 1e-011        
+dvtp1   = 0.05            lpe0    = 0               lpeb    = 0               xj_n      = 1e-008        
+ngate   = 1e+023          ndep_n    = 3.07e+018       nsd     = 2e+020          phin    = 0             
+cdsc    = 0               cdscb   = 0               cdscd   = 0               cit     = 0             
